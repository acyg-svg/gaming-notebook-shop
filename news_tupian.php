  ...
  <section id="content">
    <div id="topbar" class="affix">
      <ol class="breadcrumb">
        ...
        <li class="active" style="color:rgba(173, 111, 221, 0.66);">货物图片</li>
      </ol>
    </div>
    <div class="container">
        ...
        <div class="col-md-12">
			<div class="panel">
                <div class="panel-heading">
                  <div class="panel-title" style="color:rgba(173, 111, 221, 0.61);">货物图片</div>
                                            ...
                                            <div>
                                                <a href="#dt"><img src="image/<?=$row[1]?>"><?php echo $row[2]?><br/>
                                                    ...
                                                    <a href='insert.php?phone_photo=<?php echo $row[1]?>&phone_name=<?php echo $row[2]?>&phone_price=<?php echo $row[3]?>'>
                                                        <input type='button' name='button' value='添加购物车' style="font-size: 18px;border: 2.5px solid #ccc; border-radius: 25px;"/></a>
                                                </a>
                                            </div>
                                        </li>
                                    </ul>
