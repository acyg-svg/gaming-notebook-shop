  ...
  <section id="content">
    <div id="topbar" class="affix">
      <ol class="breadcrumb">
        ...
        <li class="active" style="color:rgba(173, 111, 221, 0.73);">货物图片</li>
      </ol>
    </div>
    <div class="container">
                ...
                <div class="panel-body">
                  <table class="table table-striped table-bordered table-hover dataTable">
                    ...
                    */
                    ...
                    $res=mysqli_query($conn,"select * from tupian");
                    ?>
                      <center>
                        <div class="wudashan">
                            <nav class="nav">
                                        ...
                                        <li>
                                            <div>
                                                <a href="#dt"><img src="image/<?=$row[1]?>"><?php echo $row[2]?><br/>
                                                    <a onclick="return confirm('确定要删除吗？');" href="xinxidel.php?id=<?php echo $row['id']  ?>" class="btn btn-default btn-gradient dropdown-toggle" ><span class="glyphicons glyphicon-trash"></span></a>
                                                    <a href="xinxiedit.php?id=<?php echo $row['id']  ?>" class="btn btn-default btn-gradient"><span class="glyphicons glyphicon-pencil"></span></a>
                                                </a>
                                            </div>
                                        </li>
                                    </ul>
